...
const UpparSection = () => {
    return (
        <div >
            <div className="Mbox1" style={{ border: "1px solid gray",borderTop:"none",borderRight:"none" ,borderLeft:"none" ,height: "40px", width: "80%", display: "flex", justifyContent: "space-evenly", overflow: "hidden", position: "fixed", top: "0.1px", marginLeft: "10%",  backgroundColor: "white" }}>
